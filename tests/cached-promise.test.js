...
import { createCachedPromise } from '@/index';
...
describe('createCachedPromise', () => {
  ...
  it('应该在检查处理器返回 false 时重新执行目标函数', async () => {
